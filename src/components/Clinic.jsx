        ...
        <div className={classes["clinic-container"]}>
          <div className={classes["clinic-text-box"]}>
            ...
            <p className={classes["clinic-description"]}>
              Localizada em região privilegiada em São José do Rio Preto, próximo ao Plaza Avenida Shopping. Contamos com estacionamento próprio, gratuito, com acessibilidade e conforto. Ambiente acolhedor, aconchegante, calmo e adequado para
              realização de consultas psiquiátricas. Seja bem vindo!
            </p>
            <a
